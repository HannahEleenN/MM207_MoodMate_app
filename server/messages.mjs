...
export const MESSAGES =
{
    ...
    NICK_TAKEN_ERROR: "Dette kallenavnet er allerede i bruk.",
    DELETE_SUCCESS: "Brukerkonto og alle tilknyttede data er slettet permanent.",
    AUTH_FAILED: "Feil kallenavn eller kode.",
